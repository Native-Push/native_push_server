...
internal sealed class IdType<T>(val nativePush: NativePush<T>) {
    ...
    abstract suspend fun updateToken(tokenId: java.util.UUID, system: PushSystem, token: kotlin.String, userId: T)
    abstract suspend fun deleteToken(tokenId: java.util.UUID, userId: T)
